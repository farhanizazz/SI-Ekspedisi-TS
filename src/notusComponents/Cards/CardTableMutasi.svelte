            ...
            <tr>
              {#each Object.keys(data[0]) as header}
                ...
                {:else if header == "nominal"}
                  <td
                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm p-4 {tableData.jenis_transaksi == 'Pembayaran Penjualan' || tableData.jenis_transaksi == 'Pembayaran Uang Jalan' ? 'text-red-500' : ''}"
                  >
