    ...
    <div class="flex justify-between items-center">
      ...
      <button
        on:click={() => {
          ...
          window.open(
            `${mainUrl}/export-pdf/transaksi/laporan/pemasukan-kendaraan-${jenis}?tanggal_awal=${tglAwal}&tanggal_akhir=${tglAkhir}&m_armada_id=[${selectedArmada == null ? "" : selectedArmada}]`
          );
        }}
